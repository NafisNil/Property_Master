...
<div class="row">
    ...
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Assigned Task Create Form</h6>
                <form action="{{ route('AssignedTask.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row"> 
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="task_no" value="{{ time() }}" readonly>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="datetime-local" class="form-control" placeholder="" name="task_date" >
                                <div class="valid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="instruction" >
                                <div class="valid-feedback"></div>
                            </div>
                        </div> 
                        <div class="col-sm-4">
