...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('fixed-asset-types.index') }}">Room Types</a></li>
                ...
                <div class="card-body">
                    <div class="text-right">
                        <a href="{{ route('room-types.create') }}">
                            <button type="button" class="btn btn-primary mb-2 text-right">Create Room Type</button>
                        </a>
                    </div>
