...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/images/logo/scpfav.png')}}" />
        <title>Login || School Optimizer</title>
                    ...
                    <div class="card">
                        <div class="row">
                            <div class="col-md-4 pr-md-0">
                                <div class="auth-left-wrapper" style="background-image: url('{{asset('assets/images/touch_logo.jpg')}}'); max-width: 90%;max-height: 80%;">
                                </div>
                            </div>
