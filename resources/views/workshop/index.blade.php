            ...
            <div class="card-body">
                <div class="text-right">
                    <a href="{{ route('Workshop.create') }}">
                        <button type="button" class="btn btn-primary mb-2 text-right">Add Workshop</button>
                    </a>
                </div>
                <h6 class="card-title">Workshop Table</h6>
                <div class="table-responsive">
                    ...
                    <table id="datatable" class="table table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center">Workshop No</th>
                        ...
                        <tbody>
                            ...
                            <?php $i = 1; ?>
                            @foreach($Workshop as $key => $row)

                            <tr>
                                <td class="text-left">{{$row->workshop_no}}</td>

                                <?php
                                $workshop_type = '';
                                if($row->workshop_type == 1){
                                    $workshop_type = 'Actual';
                                }
                                if($row->workshop_type == 2){
                                    $workshop_type = 'Virtual';
                                }
                                ?>
                                <td class="text-left">{{$workshop_type}}</td>
    ...
    <div class="modal-dialog" style="max-width: 70%; width: auto !important;">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title">Workshop Details</h2>
            </div>
...
$(".profile_details").click(function () {
    ...
    $.ajax({
        type: 'GET',
        //url: "{{route('Workshop.details', " + profile_id + ")}}",
        url: "workshop-details/" + profile_id,
        data: {},
