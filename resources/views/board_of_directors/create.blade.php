...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Add Board of Director</li>
    </ol>
</nav>
...
<div class="row">
    ...
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Board of Director Create Form</h6>
                <form action="{{ route('boardDirector.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row"> 
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="nick_name">
                                <div class="valid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="educational_level">
                                <div class="valid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="years_in_field">
                                <div class="valid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone_office" style="border-radius: 5px 0 0 5px;" name="phone_office">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone_cell" style="border-radius: 5px 0 0 5px;" name="phone_cell">
                                <span class="input-group-addon" style="padding: 10px 20px; background: #ced4da; border-radius: 0 5px 5px 0; margin-left: -5px;">Tel</span>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control"  name="dirctor_message" rows="1" style="width: 100%; padding: 10px;" ></textarea>
                            </div>
                        </div>
