...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('boardDirector.index') }}">Board of Directors</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-right">
                    <a href="{{ route('boardDirector.create') }}">
                        <button type="button" class="btn btn-primary mb-2 text-right">Add Board of Director</button>
                    </a>
                </div>
                <h6 class="card-title">Board of Director Table</h6>
                <div class="table-responsive">
                    @if(isset($board_of_directors) && !empty($board_of_directors)) 
                    @foreach($board_of_directors as $key => $row)
                    ...
                    <table id="datatable" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style=" text-align: center;"><a href="{{route('boardDirector.edit', $row->id)}}" class="btn btn-primary">Edit</a>&nbsp;&nbsp;<a href="{{route('boardDirector.destroy', $row->id)}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to Remove?');">Delete</a></td>
...
<script type="text/javascript">
                                    $(".profile_details").click(function () {
                                        ...
                                        $.ajax({
                                            type: 'GET',
                                            //url: "{{route('boardDirector.details', " + profile_id + ")}}",
                                            url: "https://schooloptimizer.golamsoroar.com/board-director-details/" + profile_id,
                                            data: {},
