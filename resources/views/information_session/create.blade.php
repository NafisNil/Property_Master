...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Add Information Session</li>
    </ol>
</nav>
...
<div class="row">
    ...
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Information Session Create Form</h6>
                <form action="{{ route('informationSession.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row"> 
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                <label for="name" class="form-label">Date <span style="color: red;">*</span></label>
                                <input type="text" class="form-control" data-provide="datepicker" name="date" readonly required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="information">
                                <div class="valid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="booking">
                                <div class="valid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="add_to_calender">
                                <div class="valid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" name="comments" rows="1" cols="50" style="width: 100%; padding: 10px; height: auto;" id="comments"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
