                ...
                <div class="card-body">
                    <div class="text-right">
                        <a href="{{ route('job-orders.create') }}">
                            <button type="button" class="btn btn-primary mb-2 text-right">Add Job Orders</button>
                        </a>
                    </div>
...
@push('js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '.view-job-order-btn', function () {
                $('#viewJobOrderModal').load($(this).data('href'), function (result) {
                    $(this).modal('show');
                })
            });

            $(document).on('click', '.delete-job-order-btn', function () {
