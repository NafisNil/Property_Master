...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Add School Closed Days</li>
    </ol>
</nav>
...
<div class="row">
    ...
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">School Closed Days Create Form</h6>
                <form action="{{ route('schoolClosedDays.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row"> 
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control sodate" data-provide="datepicker" name="date" readonly>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="event_name">
                                <div class="valid-feedback"></div>
                            </div>
                        </div>
