        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::open(['url' => route('inventory-items.update', $item->id), 'method' => "PUT"]) !!}
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                {!! Form::select('parent_id', $parentCategories, $item->parent_id, ['class' => 'form-control', 'placeholder' => 'Select Parent Category*']) !!}
                            </div>
                        </div>
