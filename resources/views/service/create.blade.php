                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('code', '', ['class' => 'form-control', 'placeholder' => 'Service Code*']) !!}
                                </div>
                            </div>

                            <div class="col-sm-6">
                                {!! Form::label('type_id', 'Service Type*', ['class' => 'control-label']) !!}
                                {!! Form::select('type_id', $serviceTypes, '', ['class' => 'form-control', 'placeholder' => 'Select Service Type*']) !!}
                            </div>

                            <div class="col-sm-6">
                                <div class="form-group">
                                    {!! Form::label('cost', 'Cost* (Per Hour)', ['class' => 'control-label']) !!}
                                    {!! Form::number('cost', '', ['class' => 'form-control', 'placeholder' => 'Cost Per Hour']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('status', [1 => 'Active', 0 => 'Inactive'], ['class' => 'form-control', 'placeholder' => 'Status']) !!}
                                </div>
                            </div>
