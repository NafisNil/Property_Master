            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-right">
                        <a href="{{ route('fixed-asset-types.create') }}">
                            <button type="button" class="btn btn-primary mb-2 text-right">Create Fixed Asset Type</button>
                        </a>
                    </div>
                    <h6 class="card-title">Fixed Account Types</h6>
