        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('fixed-asset-types.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                {!! Form::select('parent_id', $parentTypes, '', ['class' => 'form-control', 'placeholder' => 'Select Parent Category*']) !!}
                            </div>
                        </div>
