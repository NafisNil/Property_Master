    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-title">Recurring Cycle</h6>
                            ...
                            @foreach($recurring as $key => $item)
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;">
                                        ...
                                        <a
                                            href="{{route('recurring.edit', [$item])}}"
                                            class="btn btn-primary">Edit</a>
                                        <button
                                            data-href="{{route('recurring.destroy', [$item])}}"
                                            class="btn btn-danger delete-account-holder-btn"
                                        >Delete
                                        </button>

                                        {!! Form::open(['url' => route('recurring.destroy', [$item]), 'method' => 'delete', 'id'=>'deleteAccountHolderForm']) !!}
