                            ...
                            <div class="col-12">
                                <table class="table table-bordered" id="time_sheet_table">
                                    ...
                                    @foreach($timeSheet->items as $index=>$item)
                                        @include('time-sheet.item-row', ['index' => $index, 'item' => $item])
                                    @endforeach
                                    </tbody>
                                    <tfoot>
                                    <tr>
