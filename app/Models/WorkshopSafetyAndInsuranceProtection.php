...
class WorkshopSafetyAndInsuranceProtection extends Model {

    use HasFactory;

    protected $table = 'workshop_safety_and_insurance_protection';
    protected $fillable = [
        'insurance_type', 'staff', 'students', 'fixed_assets', 'property',
        'insurer', 'expiry_date', 'status', 'created_by', 'created_at',
        'updated_by'
    ];
