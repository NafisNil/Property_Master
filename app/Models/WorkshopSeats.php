...
class WorkshopSeats extends Model {

    use HasFactory;

    protected $table = 'workshop_seats';
    protected $fillable = [
        'seat_no', 'occupant', 'id_no', 'first_name', 'middle_name',
        'last_name', 'photo', 'ph_no',
        'email', 'student_type', 'seat_status','comment', 'status', 'created_by', 'created_at',
        'updated_by'
    ];
