...
use App\Models\SchoolClosedDays;
use App\Models\Campus;
use App\Models\CourseOutlines;

class SchoolClosedDaysController extends Controller {
    ...
    public function index() {
        ...
        $schoolClosedDays = SchoolClosedDays::get();
        $school_info = School::where('id', $school_id)->first();
        return view('school_closed_days.index', compact('school_info', 'schoolClosedDays'));
    }
    ...
    public function create() {
        ...
        $school_id = Users::where('id', $user_id)->first()->school;
        $school_info = School::where('id', $school_id)->first();
        return view('school_closed_days.create', compact('school_info'));
    }
    ...
    public function store(Request $request) {
        ...
        SchoolClosedDays::create($request->all());

        return redirect()->route('schoolClosedDays.index')
    ...
    public function edit($id) {
        if (isset($id) && !empty($id)) {
            ...
            $school_id = Users::where('id', $user_id)->first()->school;
            $school_info = School::where('id', $school_id)->first();
            $schoolClosedDays = SchoolClosedDays::where('id', $id)->first();
            return view('school_closed_days.edit', compact('school_info', 'schoolClosedDays'));
        } else {
    ...
    public function update(Request $request) {
        ...
        $bdirec = SchoolClosedDays::find($request->id);
    ...
    public function destroy($id) {
        $color = SchoolClosedDays::find($id);
        $color->delete();
    ...
    public function details($id) {
        $classesSchedule = SchoolClosedDays::where('id', $id)->first();
